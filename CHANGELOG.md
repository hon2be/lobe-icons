...
- **docs**: Migrate to lobedocs, closes [#366](https://github.com/lobehub/lobe-icons/issues/366) ([debf214](https://github.com/lobehub/lobe-icons/commit/debf214))
...
## [Version 5.7.0](https://github.com/lobehub/lobe-icons/compare/v5.6.0...v5.7.0)
...
- **auto**: Auto build static icons ([25a96c0](https://github.com/lobehub/lobe-icons/commit/25a96c0))
...
- **misc**: Fix build ([6c27cb1](https://github.com/lobehub/lobe-icons/commit/6c27cb1))
...
- **misc**: Lock bun ([5264564](https://github.com/lobehub/lobe-icons/commit/5264564))
...
- **misc**: Update @lobehub/ui to version 5.0.0 in package.json ([bdddcc2](https://github.com/lobehub/lobe-icons/commit/bdddcc2))
...
- **misc**: Update @lobehub/ui to version 5.0.0 in package.json \[force major].
...
- **misc**: Update @lobehub/ui to version 5.0.0 in package.json \[force major] ([9d14ac5](https://github.com/lobehub/lobe-icons/commit/9d14ac5))
...
- **misc**: Add ace-step ([c74a116](https://github.com/lobehub/lobe-icons/commit/c74a116))
...
## [Version 4.9.0](https://github.com/lobehub/lobe-icons/compare/v4.8.0...v4.9.0)
...
## [Version 4.8.0](https://github.com/lobehub/lobe-icons/compare/v4.7.0...v4.8.0)
...
- **misc**: Add seedance keyword to Doubao model mapping, add seedance keyword to Doubao model mapping.
...
- **misc**: Add seedance keyword to Doubao model mapping ([2710aae](https://github.com/lobehub/lobe-icons/commit/2710aae))
...
- **misc**: Fix build ([035564a](https://github.com/lobehub/lobe-icons/commit/035564a))
...
- **misc**: GetLobeIconCDN ([abef2a2](https://github.com/lobehub/lobe-icons/commit/abef2a2))
...
### [Version 4.0.2](https://github.com/lobehub/lobe-icons/compare/v4.0.1...v4.0.2)
...
- **misc**: Fix build ([d7cea8d](https://github.com/lobehub/lobe-icons/commit/d7cea8d))
...
- **misc**: Bump v4 \[force major] ([d76f0fe](https://github.com/lobehub/lobe-icons/commit/d76f0fe))
...
### [Version 3.0.2](https://github.com/lobehub/lobe-icons/compare/v3.0.1...v3.0.2)

<sup>Released on **2025-12-23**</sup>

#### 🐛 Bug Fixes

- **misc**: Fix dependencies.
...
- **misc**: Fix dependencies ([441c9a0](https://github.com/lobehub/lobe-icons/commit/441c9a0))
...
- **auto**: Auto build static icons.
- **misc**: Add KwaiKat, CyberCut, CodeFlicker, StreamLake.
...
- **misc**: Add KwaiKat, CyberCut, CodeFlicker, StreamLake ([ec58d84](https://github.com/lobehub/lobe-icons/commit/ec58d84))
...
- **rn**: Update rn ([cbad2fb](https://github.com/lobehub/lobe-icons/commit/cbad2fb))
...
- **misc**: Add Sora 2 ([f5a8635](https://github.com/lobehub/lobe-icons/commit/f5a8635))
...
- **misc**: Update cursor assets, closes [#190](https://github.com/lobehub/lobe-icons/issues/190) ([74c767f](https://github.com/lobehub/lobe-icons/commit/74c767f))
...
- **model**: Improve model matching rules and fix TypeScript error ([f6ca5f6](https://github.com/lobehub/lobe-icons/commit/f6ca5f6))
...
- **misc**: Fix download ([f0a5167](https://github.com/lobehub/lobe-icons/commit/f0a5167))
...
- **misc**: Add Bfl ([25d8264](https://github.com/lobehub/lobe-icons/commit/25d8264))
...
- **misc**: Add gpt-5 gpt-oss ([8424d49](https://github.com/lobehub/lobe-icons/commit/8424d49))
...
- **misc**: Update modelConfig ([e535a1d](https://github.com/lobehub/lobe-icons/commit/e535a1d))
- **misc**: Update modelConfig ([6609fba](https://github.com/lobehub/lobe-icons/commit/6609fba))
...
- **misc**: Add GLM-V ([5e532c7](https://github.com/lobehub/lobe-icons/commit/5e532c7))
...
- **rn**: ModelConfig update ([74b34e8](https://github.com/lobehub/lobe-icons/commit/74b34e8))
...
- **rn**: Update peer deps & docs ([d479f7d](https://github.com/lobehub/lobe-icons/commit/d479f7d))
...
- **misc**: Upgrade react-layout-kit, closes [#144](https://github.com/lobehub/lobe-icons/issues/144) ([5d11776](https://github.com/lobehub/lobe-icons/commit/5d11776))
...
- **misc**: Add Mastra, CopilotKit, AG-UI ([a7faf94](https://github.com/lobehub/lobe-icons/commit/a7faf94))
...
- **misc**: Fix some style issues ([57ba599](https://github.com/lobehub/lobe-icons/commit/57ba599))
...
- **misc**: Add AlibabaCloud icon for Qwen, closes [#116](https://github.com/lobehub/lobe-icons/issues/116) ([7459c07](https://github.com/lobehub/lobe-icons/commit/7459c07))
